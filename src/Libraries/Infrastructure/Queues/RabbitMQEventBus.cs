...
namespace Infrastructure.Queues
{
   ...
   {
        const string BROKER_NAME = "dh_event_bus";
        ...
        {
            _subsManager.RemoveDynamicSubscription<TEventHandler>(eventName);
        }
        ...
        private async Task ProcessEvent(string eventName, string message)
        {
            ...
            foreach (var subscription in subscriptions)
            {
                ...
                {
                    var handler = _serviceProvider.GetService(subscription.HandlerType) as IDynamicEventHandler;
                ...
                else
                {
                    ...
                    var domainEvent = System.Text.Json.JsonSerializer.Deserialize(message, eventType, new JsonSerializerOptions() { PropertyNameCaseInsensitive = true });
