...
namespace DAL.Windows.DataMappings
{
    public partial class ProdutooldMap
        : IEntityTypeConfiguration<Legacy.Entities.Produtoold>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Legacy.Entities.Produtoold> builder)
        {
