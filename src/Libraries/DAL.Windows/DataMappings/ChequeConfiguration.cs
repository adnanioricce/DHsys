...
namespace DAL.Windows.DataMappings
{
    public partial class ChequeMap
        : IEntityTypeConfiguration<Legacy.Entities.Cheque>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Legacy.Entities.Cheque> builder)
        {
