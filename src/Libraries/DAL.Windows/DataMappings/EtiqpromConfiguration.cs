...
namespace DAL.Windows.DataMappings
{
    public partial class EtiqpromMap
        : IEntityTypeConfiguration<Legacy.Entities.Etiqprom>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Legacy.Entities.Etiqprom> builder)
        {
