...
namespace DAL.Windows.DataMappings
{
    public partial class RelatorMap
        : IEntityTypeConfiguration<Legacy.Entities.Relator>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Legacy.Entities.Relator> builder)
        {
