...
namespace DAL.Windows.DataMappings
{
    public partial class DeliveryMap
        : IEntityTypeConfiguration<Legacy.Entities.Delivery>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Legacy.Entities.Delivery> builder)
        {
