...
namespace DAL.Windows.DataMappings
{
    public partial class PedidosMap
        : IEntityTypeConfiguration<Legacy.Entities.Pedidos>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Legacy.Entities.Pedidos> builder)
        {
