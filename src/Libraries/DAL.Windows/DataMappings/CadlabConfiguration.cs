...
namespace DAL.Windows.DataMappings
{
    public partial class CadlabMap
        : IEntityTypeConfiguration<Legacy.Entities.Cadlab>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Legacy.Entities.Cadlab> builder)
        {
