...
namespace DAL.Windows.DataMappings
{
    public partial class MovmeMap
        : IEntityTypeConfiguration<Legacy.Entities.Movme>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Legacy.Entities.Movme> builder)
        {
