...
{
    public partial class Produtoold
    {
        public Produtoold()
        {
        ...
        public decimal? Prcons { get; set; }

        public decimal? Prconscv { get; set; }

        public decimal? Prfabr { get; set; }

        public string Prfixa { get; set; }

        public decimal? Prpromo { get; set; }

        public decimal? Vlcomis { get; set; }

        public decimal? Prestq { get; set; }

        public decimal? Prinicial { get; set; }

        public decimal? Prtestq { get; set; }
        ...
        public decimal? Premb { get; set; }

        public decimal? Prentr { get; set; }
        ...
        public decimal? Prmesant { get; set; }
        ...
        public decimal? Vendatu { get; set; }

        public decimal? Vendant { get; set; }
