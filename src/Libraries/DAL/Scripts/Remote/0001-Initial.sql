...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200605200155_InitialCreate-sqlserver-05-06-2020')
BEGIN
...
BEGIN
    CREATE TABLE [Syncronization] (
        ...
        [CreatedAt] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:53.5820460+00:00',
        [LastUpdatedOn] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:53.5823486+00:00',
        [UpdatedFrom] nvarchar(max) NULL,
        [LastSyncronization] datetimeoffset NOT NULL,
...
BEGIN
    CREATE TABLE [Beneficiary] (
        ...
        [UniqueCode] nvarchar(max) NULL,
        [IsDeleted] bit NOT NULL DEFAULT CAST(0 AS bit),
        [CreatedAt] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4214250+00:00',
        [LastUpdatedOn] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4214693+00:00',
        [Name] nvarchar(max) NULL,
        [Discriminator] nvarchar(max) NOT NULL,
        [AddressId] int NULL,
        [Cpf] nvarchar(max) NULL,
        [Manufacturer_AddressId] int NULL,
        [Cnpj] nvarchar(max) NULL,
        CONSTRAINT [PK_Beneficiary] PRIMARY KEY ([Id]),
        CONSTRAINT [FK_Beneficiary_Addresses_AddressId] FOREIGN KEY ([AddressId]) REFERENCES [Addresses] ([Id]) ON DELETE NO ACTION,
        CONSTRAINT [FK_Beneficiary_Addresses_Manufacturer_AddressId] FOREIGN KEY ([Manufacturer_AddressId]) REFERENCES [Addresses] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE TABLE [Supplier] (
        ...
        [UniqueCode] nvarchar(max) NULL,
        [IsDeleted] bit NOT NULL DEFAULT CAST(0 AS bit),
        [CreatedAt] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:53.8612249+00:00',
        [LastUpdatedOn] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:53.8612822+00:00',
        [AddressId] int NULL,
...
BEGIN
    CREATE TABLE [StockEntry] (
        ...
        [UniqueCode] nvarchar(max) NULL,
        [IsDeleted] bit NOT NULL DEFAULT CAST(0 AS bit),
        [CreatedAt] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:53.8606858+00:00',
        [LastUpdatedOn] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:53.8607200+00:00',
        [SupplierId] int NULL,
        [Quantity] int NULL,
        ...
        CONSTRAINT [FK_StockEntry_Supplier_SupplierId] FOREIGN KEY ([SupplierId]) REFERENCES [Supplier] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE TABLE [Products] (
        ...
        [UniqueCode] nvarchar(max) NULL,
        [IsDeleted] bit NOT NULL DEFAULT CAST(0 AS bit),
        [CreatedAt] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4222215+00:00',
        [LastUpdatedOn] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4222585+00:00',
        [Ncm] nvarchar(max) NULL,
        ...
        CONSTRAINT [FK_Products_StockEntry_StockEntryId] FOREIGN KEY ([StockEntryId]) REFERENCES [StockEntry] ([Id]) ON DELETE NO ACTION,
...
BEGIN
    CREATE TABLE [DrugInformation] (
        ...
        [UniqueCode] nvarchar(max) NULL,
        [IsDeleted] bit NOT NULL DEFAULT CAST(0 AS bit),
        [CreatedAt] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4228374+00:00',
        [LastUpdatedOn] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4228834+00:00',
        [DrugId] int NULL,
...
BEGIN
    CREATE TABLE [ProductPrice] (
        ...
        [UniqueCode] nvarchar(max) NULL,
        [IsDeleted] bit NOT NULL DEFAULT CAST(0 AS bit),
        [CreatedAt] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4293344+00:00',
        [LastUpdatedOn] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4293726+00:00',
...
BEGIN
    CREATE TABLE [ProductShelfLife] (
        ...
        [UniqueCode] nvarchar(max) NULL,
        [IsDeleted] bit NOT NULL DEFAULT CAST(0 AS bit),
        [CreatedAt] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4299880+00:00',
        [LastUpdatedOn] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4300219+00:00',
        [ProductId] int NOT NULL,
...
BEGIN
    CREATE TABLE [ProductStockEntry] (
        ...
        [UniqueCode] nvarchar(max) NULL,
        [IsDeleted] bit NOT NULL DEFAULT CAST(0 AS bit),
        [CreatedAt] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4305746+00:00',
        [LastUpdatedOn] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4306113+00:00',
        [ProductId] int NOT NULL,
        [StockEntryId] int NOT NULL,
...
BEGIN
    CREATE TABLE [ProductSupplier] (
        ...
        [UniqueCode] nvarchar(max) NULL,
        [IsDeleted] bit NOT NULL DEFAULT CAST(0 AS bit),
        [CreatedAt] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4311707+00:00',
        [LastUpdatedOn] datetimeoffset NOT NULL DEFAULT '2020-06-05T20:01:54.4312055+00:00',
        [ProductId] int NOT NULL,
...
BEGIN
    ...
    VALUES (1, 0, N'empresa', '0001-01-01T00:00:00.0000000+00:00', NULL, '2020-06-05T20:01:54.3976733Z', CAST(0 AS bit), CAST(0 AS bit), '2020-06-05T20:01:54.3975693+00:00', 0, 12.99, NULL);
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'BeneficiaryId', N'BeneficiaryName', N'CreatedAt', N'Discount', N'EndDate', N'IsDeleted', N'IsPaid', N'LastUpdatedOn', N'PersonType', N'Price', N'UniqueCode') AND [object_id] = OBJECT_ID(N'[Billings]'))
...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'BeneficiaryId', N'BeneficiaryName', N'CreatedAt', N'Discount', N'EndDate', N'IsDeleted', N'IsPaid', N'LastUpdatedOn', N'PersonType', N'Price', N'UniqueCode') AND [object_id] = OBJECT_ID(N'[Billings]'))
        SET IDENTITY_INSERT [Billings] ON;
    INSERT INTO [Billings] ([Id], [BeneficiaryId], [BeneficiaryName], [CreatedAt], [Discount], [EndDate], [IsDeleted], [IsPaid], [LastUpdatedOn], [PersonType], [Price], [UniqueCode])
    VALUES (2, 0, N'empresa 2', '0001-01-01T00:00:00.0000000+00:00', NULL, '2020-06-05T20:01:54.3978836Z', CAST(0 AS bit), CAST(0 AS bit), '2020-06-05T20:01:54.3978826+00:00', 0, 22.99, NULL);
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'BeneficiaryId', N'BeneficiaryName', N'CreatedAt', N'Discount', N'EndDate', N'IsDeleted', N'IsPaid', N'LastUpdatedOn', N'PersonType', N'Price', N'UniqueCode') AND [object_id] = OBJECT_ID(N'[Billings]'))
        SET IDENTITY_INSERT [Billings] OFF;
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200605200155_InitialCreate-sqlserver-05-06-2020')
BEGIN
    CREATE INDEX [IX_Beneficiary_AddressId] ON [Beneficiary] ([AddressId]);
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200605200155_InitialCreate-sqlserver-05-06-2020')
BEGIN
    CREATE INDEX [IX_Beneficiary_Manufacturer_AddressId] ON [Beneficiary] ([Manufacturer_AddressId]);
END;
...
BEGIN
    ...
    VALUES (N'20200605200155_InitialCreate-sqlserver-05-06-2020', N'3.1.3');
END;
