        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RiskClass = table.Column<string>(type: "varchar(3)", nullable: false),
                    Concentration = table.Column<string>(type: "real", nullable: true),
                    FisicForm = table.Column<string>(type: "VARCHAR(256)",nullable:true),
                    ...
                    UseRestriction = table.Column<string>(type: "VARCHAR(128)", nullable: false),
                    ...
                    RegistryPublicationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable:true),
                    DateOfRegistryUpdate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable:true),
                    RegistryValidity = table.Column<string>(type: "varchar(64)", nullable: true),
                    MedicalProductModel = table.Column<string>(type: "text", nullable: true),
                    Stripe = table.Column<string>(type:"varchar(128)",nullable:true),
                    UniqueCode = table.Column<string>(type: "text", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
