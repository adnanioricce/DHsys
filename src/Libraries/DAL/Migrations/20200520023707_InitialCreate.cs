    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "empresa", null, new DateTime(2020, 5, 20, 2, 37, 5, 686, DateTimeKind.Utc).AddTicks(6182), false, new DateTimeOffset(new DateTime(2020, 5, 20, 2, 37, 5, 686, DateTimeKind.Unspecified).AddTicks(5567), new TimeSpan(0, 0, 0, 0, 0)), 0, 12.99m, null });

            migrationBuilder.InsertData(
                table: "Billings",
                columns: new[] { "Id", "BeneficiaryId", "BeneficiaryName", "Discount", "EndDate", "IsPaid", "LastUpdatedOn", "PersonType", "Price", "UniqueCode" },
                values: new object[] { 2, 0, "empresa 2", null, new DateTime(2020, 5, 20, 2, 37, 5, 686, DateTimeKind.Utc).AddTicks(8372), false, new DateTimeOffset(new DateTime(2020, 5, 20, 2, 37, 5, 686, DateTimeKind.Unspecified).AddTicks(8355), new TimeSpan(0, 0, 0, 0, 0)), 0, 22.99m, null });
